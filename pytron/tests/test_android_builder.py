...
def test_build_wheel_uses_prebuilt(builder, tmp_path):
    ...
    # Mock repair_wheel
    with patch.object(builder, "_fetch_prebuilt_wheel", return_value=True) as mock_fetch, \
...
def test_build_wheel_fallback_to_build(builder, tmp_path):
    ...
    with patch.object(builder, "_fetch_prebuilt_wheel", return_value=False) as mock_fetch, \
